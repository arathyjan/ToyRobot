...
RSpec.describe CommandFactory do
  describe '.parse' do
    ...
    context 'parsing Left command' do
      it 'should parse Left command' do
        expect(described_class.create 'LEFT').to be_an_instance_of Commands::Left
      end
    end

    context 'parsing Report command' do
      it 'should parse Report command' do
        expect(described_class.create 'REPORT').to be_an_instance_of Commands::Report
      end
    end
